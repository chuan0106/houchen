...
const Index: FC<Props> = () => {
    return (
        <div className={styles.card}>
            ...
            <div className={`${styles.box} ${styles.box2}`}> <span className={styles.icon} ><svg viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg"
                className={styles.svg}>
                <path
            ...
            <div className={`${styles.box} ${styles.box3}`}><span className={styles.icon}><svg viewBox="0 0 640 512" xmlns="http://www.w3.org/2000/svg"
                className={styles.svg}>
                <path
