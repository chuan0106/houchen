...
import { zhoukoushi } from '@/pages/data/map';
type Props = {
    layerActive: any
}
const Zhoukoushi: FC<Props> = ({ layerActive }) => {
    return zhoukoushi.map((layer, i) => (
...
export default connect(mapStateToProps)(Zhoukoushi);