...
import type { dispatchType } from '@/interface/houchen'
type Props = {

}
const Index: FC<Props> = () => {
    const dispatch = useDispatch();
    const menuNameHandler = (name: string) => {
    ...
    return (
        <div className={styles.card}>
            ...
            <div className={styles.logo} >
                <svg className={styles.logo_svg} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 29.667 31.69" >
            ...
            <div
                onClick={() => { menuNameHandler('首页') }}
                className={`${styles.box} ${styles.box3}`}><span className={styles.icon}><svg viewBox="0 0 640 512" xmlns="http://www.w3.org/2000/svg"
                    className={styles.svg}>
                    <path
